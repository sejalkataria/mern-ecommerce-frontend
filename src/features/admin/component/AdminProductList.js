            ...
            <div>
                <div className="bg-white">
                    <div>
                        ...
                        <MobileFilter filters={filters} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} handleFilter={handleFilter}></MobileFilter>

                        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                                <h1 className="text-4xl font-bold tracking-tight text-gray-900">All Products Edit</h1>
                    ...
                    <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        ...
                        {Array.from({ length: totalPages }).map((el, index) =>
                            <div
                                ...
                                aria-current="page"
                                className={`relative z-10 inline-flex items-center ${(index + 1) === page ? 'bg-indigo-600 text-white' : 'text-gray-400'} cursor-pointer border border-gray-300 px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                            >
                                {index + 1}
                            </div>
                        )}
                    ...
                    {products.map((product) => (
                        <div>
                            <Link to={`/product-detail/${product.id}`} key={product.id}>
                                <div key={product.id} className="group relative p-2 border-solid border-2 border-gray-200">
