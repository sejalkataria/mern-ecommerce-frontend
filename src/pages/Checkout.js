        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gird-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                <div className="lg:col-span-3">
                    <form className="bg-white px-5 py-12 mt-12" action="">
                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <ul role="list">
                                    {addresses.map((address) => (
                                        <li key={address.name} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
